...
function initDatePicker() {
    ...
    function updatePriceBreakdown() {
        ...
        const dailyRate = 6600; // DZD per day
        const serviceFee = 1000; // DZD
        ...
        if (days > 0) {
            ...
            priceItems[0].innerHTML = `<span>${dailyRate} DZD x ${days} jours</span><span>${subtotal} DZD</span>`;
...
function initContactButton() {
    ...
    contactBtn.addEventListener('click', function() {
        ...
        alert('Fonctionnalité de contact en cours de développement. Vous pourrez bientôt contacter le propriétaire directement.');
    });
}
