document.addEventListener("DOMContentLoaded", () => {
  ...
  function saveFormData() {
    const formData = {
      ...
      services: {
        livraison: {
          enabled: document.getElementById("livraison").checked,
          rayon: document.getElementById("rayon-livraison").value,
          frais: document.getElementById("frais-livraison").value,
        },
        pleinEssence: document.getElementById("plein-essence").checked,
        nettoyage: {
          enabled: document.getElementById("nettoyage").checked,
          frais: document.getElementById("frais-nettoyage").value,
        },
      },
      restrictions: {
        ...
        kmLimite: {
          enabled: document.getElementById("km-limite").checked,
          limite: document.getElementById("limite-km").value,
          frais: document.getElementById("frais-km").value,
        },
      },
    };

    localStorage.setItem("carshare_options", JSON.stringify(formData));
  }
